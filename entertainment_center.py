...
crash = media.Movie("Crash", "The lives of several strangers become intertwined over a single event",
                    "http://i41.tinypic.com/3358pav.jpg",
                    "https://www.youtube.com/watch?v=durNwe9pL0E")
guardians = media.Movie("Guardians of the Galaxy", "An adventure through space",
...
district9 = media.Movie("District 9", "A realistic look of how humanity might interect with aliens if they ever joined our society",
